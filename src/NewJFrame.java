...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public boolean con(){
        try{
            ...
            String url = "jdbc:MySQL://localhost:3306/ekios_db"; /* masukkan nama database yang digunakan */
            String user = "root";
            String pass = "";
        ...
        if(con()){
            try{
                ...
                while (sr.next()){
                    ...
                    if (sr.getString(2).equals(username) && sr.getString(3).equals(password)){
